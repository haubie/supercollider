defmodule SuperCollider.SoundServer.Command do
  ...
  def send_to_sc(soundserver, osc_message) do
    :gen_udp.send(soundserver.socket, soundserver.hostname, soundserver.port, osc_message)
  end
              ...
              :hostname =>
                ...
                | {:inet
                   ...
                   | {:any
                      | :loopback
                      | {any, any, any, any}
                      | {any, any, any, any, any, any, any, any}, char}}
                | {byte, byte, byte, byte}
                | {char, char, char, char, char, char, char, char}
                | %{
                    :addr =>
                    ...
                    :family => :inet | :inet6,
                    :port => char,
                    optional(:flowinfo) => char,
                    optional(:scope_id) => non_neg_integer
                  },
              :port => atom | [{:tclass, byte} | {:tos, byte} | {:ttl, byte}] | char,
